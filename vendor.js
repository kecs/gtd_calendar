...
require.define({
  'chaplin/views/collection_view': function(exports, require, module) {
    var $, CollectionView, View, _, _ref;
    ...
    return module.exports = CollectionView = (function(_super) {
      ...
      function CollectionView() {
        ...
        this.itemAdded = __bind(this.itemAdded, this);        _ref = CollectionView.__super__.constructor.apply(this, arguments);
        return _ref;
      }
...
defined (or the getView() must be overridden)');
      ...
      CollectionView.prototype.filter = function(filterer, callback) {
        var included, index, item, view, _i, _len, _ref1,
          _this = this;
      ...
      CollectionView.prototype.renderAllItems = function() {
        var cid, index, item, items, remainingViewsByCid, view, _i, _j, _len, _len1, _ref1;
        ...
        for (cid in _ref1) {
          if (!__hasProp.call(_ref1, cid)) continue;
          view = _ref1[cid];
      ...
      CollectionView.prototype.dispose = function() {
        var cid, prop, properties, view, _i, _len, _ref1;
